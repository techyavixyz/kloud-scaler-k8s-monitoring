...
import { Menu, Sun, Moon, Bell, Search, Wifi, WifiOff, LogOut } from 'lucide-react';
      ...
      <div className="flex items-center justify-between px-4 py-3 lg:px-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative group">
            <div className="w-8 h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center cursor-pointer">
