        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
            ...
            <select
              ...
              className="text-white w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
            >
        ...
        <div className="space-y-6">
          <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
            ...
            <select
              ...
              className="text-white w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
